...
const Setting = () => {
    ...
    useEffect(() => {
        ...
        if (navigator.geolocation && !router.query.idsafezone) {
            navigator.geolocation.getCurrentPosition((position) => {
                ...
                setAlert({ show: true, message: 'ไม่สามารถระบุตำแหน่งปัจจุบันได้ กรุณาเปิดใช้งาน GPS หรืออนุญาตการเข้าถึงตำแหน่ง' });
            });
        }
    }, [router.query.auToken, router.isReady]);
    ...
    // Removed useMemo center dependency on location
